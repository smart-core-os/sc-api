...
goog.exportSymbol('proto.smartcore.types.Volume', null, global);
/**
 ...
 * @constructor
 */
proto.smartcore.types.Volume = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.smartcore.types.Volume, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.smartcore.types.Volume.displayName = 'proto.smartcore.types.Volume';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.smartcore.types.Volume.prototype.toObject = function(opt_includeInstance) {
  return proto.smartcore.types.Volume.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.smartcore.types.Volume} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.smartcore.types.Volume.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.smartcore.types.Volume.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.smartcore.types.Volume;
  return proto.smartcore.types.Volume.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.smartcore.types.Volume} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.smartcore.types.Volume}
 */
proto.smartcore.types.Volume.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.smartcore.types.Volume.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.smartcore.types.Volume.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.smartcore.types.Volume} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.smartcore.types.Volume.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getGain();
  if (f != null) {
    writer.writeMessage(
 ...
 */
proto.smartcore.types.Volume.prototype.getGain = function() {
  return /** @type{?proto.smartcore.types.FloatVar} */ (
    jspb.Message.getWrapperField(this, types_number_pb.FloatVar, 1));
};


/**
 * @param {?proto.smartcore.types.FloatVar|undefined} value
 * @return {!proto.smartcore.types.Volume} returns this
*/
proto.smartcore.types.Volume.prototype.setGain = function(value) {
 ...
 * @return {!proto.smartcore.types.Volume} returns this
 */
proto.smartcore.types.Volume.prototype.clearGain = function() {
 ...
 * @return {boolean}
 */
proto.smartcore.types.Volume.prototype.hasGain = function() {
 ...
 * @return {boolean}
 */
proto.smartcore.types.Volume.prototype.getMute = function() {
 ...
 * @return {!proto.smartcore.types.Volume} returns this
 */
proto.smartcore.types.Volume.prototype.setMute = function(value) {
