...
goog.exportSymbol('proto.smartcore.traits.PullAirTemperatureStateResponse.Change', null, global);
 ...
 * @constructor
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.Change = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.smartcore.traits.PullAirTemperatureStateResponse.Change, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.smartcore.traits.PullAirTemperatureStateResponse.Change.displayName = 'proto.smartcore.traits.PullAirTemperatureStateResponse.Change';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.smartcore.traits.PullAirTemperatureStateResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.smartcore.traits.PullAirTemperatureStateResponse.Change.toObject, includeInstance)
  };
...
proto.smartcore.traits.PullAirTemperatureStateResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.smartcore.traits.PullAirTemperatureStateResponse.Change;
      reader.readMessage(value,proto.smartcore.traits.PullAirTemperatureStateResponse.Change.deserializeBinaryFromReader);
...
proto.smartcore.traits.PullAirTemperatureStateResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.smartcore.traits.PullAirTemperatureStateResponse.Change.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.Change.prototype.toObject = function(opt_includeInstance) {
  return proto.smartcore.traits.PullAirTemperatureStateResponse.Change.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.smartcore.traits.PullAirTemperatureStateResponse.Change} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.smartcore.traits.PullAirTemperatureStateResponse.Change}
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.Change.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.smartcore.traits.PullAirTemperatureStateResponse.Change;
  return proto.smartcore.traits.PullAirTemperatureStateResponse.Change.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.smartcore.traits.PullAirTemperatureStateResponse.Change} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.smartcore.traits.PullAirTemperatureStateResponse.Change}
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.Change.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.Change.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.smartcore.traits.PullAirTemperatureStateResponse.Change.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.smartcore.traits.PullAirTemperatureStateResponse.Change} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.Change.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.Change.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.Change.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {?proto.smartcore.traits.AirTemperatureState}
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.Change.prototype.getState = function() {
  return /** @type{?proto.smartcore.traits.AirTemperatureState} */ (
 ...
 * @return {!proto.smartcore.traits.PullAirTemperatureStateResponse.Change} returns this
*/
proto.smartcore.traits.PullAirTemperatureStateResponse.Change.prototype.setState = function(value) {
  return jspb.Message.setWrapperField(this, 3, value);
};
 ...
 * @return {!proto.smartcore.traits.PullAirTemperatureStateResponse.Change} returns this
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.Change.prototype.clearState = function() {
  return this.setState(undefined);
};
 ...
 * @return {boolean}
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.Change.prototype.hasState = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {!Array<!proto.smartcore.traits.PullAirTemperatureStateResponse.Change>}
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.prototype.getChangesList = function() {
  return /** @type{!Array<!proto.smartcore.traits.PullAirTemperatureStateResponse.Change>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.smartcore.traits.PullAirTemperatureStateResponse.Change, 1));
};


/**
 * @param {!Array<!proto.smartcore.traits.PullAirTemperatureStateResponse.Change>} value
...
/**
 * @param {!proto.smartcore.traits.PullAirTemperatureStateResponse.Change=} opt_value
 * @param {number=} opt_index
 * @return {!proto.smartcore.traits.PullAirTemperatureStateResponse.Change}
 */
proto.smartcore.traits.PullAirTemperatureStateResponse.prototype.addChanges = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.smartcore.traits.PullAirTemperatureStateResponse.Change, opt_index);
};
 ...
 * @return {?proto.smartcore.api.types.Temperature}
 */
proto.smartcore.traits.AirTemperatureState.prototype.getDewPoint = function() {
  return /** @type{?proto.smartcore.api.types.Temperature} */ (
 ...
 * @return {!proto.smartcore.traits.AirTemperatureState} returns this
*/
proto.smartcore.traits.AirTemperatureState.prototype.setDewPoint = function(value) {
 ...
 * @return {!proto.smartcore.traits.AirTemperatureState} returns this
 */
proto.smartcore.traits.AirTemperatureState.prototype.clearDewPoint = function() {
 ...
 * @return {boolean}
 */
proto.smartcore.traits.AirTemperatureState.prototype.hasDewPoint = function() {
