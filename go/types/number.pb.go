...
type Int32Var struct {
	...
	TargetValue *wrapperspb.Int32Value `protobuf:"bytes,3,opt,name=target_value,json=targetValue,proto3" json:"target_value,omitempty"`
}
...
func (x *Int32Var) GetValue() *wrapperspb.Int32Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *Int32Var) GetTargetValue() *wrapperspb.Int32Value {
	if x != nil {
...
type FloatVar struct {
	...
	Ramp *Tween `protobuf:"bytes,2,opt,name=ramp,proto3" json:"ramp,omitempty"`
	// If ramping, then defines the value that we are ramping towards
	TargetValue *wrapperspb.FloatValue `protobuf:"bytes,3,opt,name=target_value,json=targetValue,proto3" json:"target_value,omitempty"`
}
...
func (x *FloatVar) GetValue() *wrapperspb.FloatValue {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *FloatVar) GetTargetValue() *wrapperspb.FloatValue {
	if x != nil {
		return x.TargetValue
	}
	return nil
...
var file_types_number_proto_rawDesc = []byte{
	...
	0x52, 0x10, 0x02, 0x12, 0x09, 0x0a, 0x05, 0x41, 0x4c, 0x4c, 0x4f, 0x57, 0x10, 0x03, 0x42, 0x60,
