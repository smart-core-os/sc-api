...
func (x *PullChosenChannelResponse_Change) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
var file_traits_channel_proto_depIdxs = []int32{
	...
	9, // 2: smartcore.traits.PullChosenChannelResponse.Change.create_time:type_name -> google.protobuf.Timestamp
