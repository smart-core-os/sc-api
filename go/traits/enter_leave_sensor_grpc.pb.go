...
func (c *enterLeaveSensorApiClient) PullEnterLeaveEvents(ctx context.Context, in *PullEnterLeaveEventsRequest, opts ...grpc.CallOption) (EnterLeaveSensorApi_PullEnterLeaveEventsClient, error) {
	stream, err := c.cc.NewStream(ctx, &EnterLeaveSensorApi_ServiceDesc.Streams[0], EnterLeaveSensorApi_PullEnterLeaveEvents_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *enterLeaveSensorApiClient) GetEnterLeaveEvent(ctx context.Context, in *GetEnterLeaveEventRequest, opts ...grpc.CallOption) (*EnterLeaveEvent, error) {
	...
	err := c.cc.Invoke(ctx, EnterLeaveSensorApi_GetEnterLeaveEvent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *enterLeaveSensorApiClient) ResetEnterLeaveTotals(ctx context.Context, in *ResetEnterLeaveTotalsRequest, opts ...grpc.CallOption) (*ResetEnterLeaveTotalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, EnterLeaveSensorApi_ResetEnterLeaveTotals_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
