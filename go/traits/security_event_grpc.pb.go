...
const (
	SecurityEventApi_ListSecurityEvents_FullMethodName = "/smartcore.traits.SecurityEventApi/ListSecurityEvents"
	SecurityEventApi_PullSecurityEvents_FullMethodName = "/smartcore.traits.SecurityEventApi/PullSecurityEvents"
)
...
var SecurityEventApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.traits.SecurityEventApi",
	...
	Metadata: "traits/security_event.proto",
}
