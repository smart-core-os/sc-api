...
func (c *countApiClient) GetCount(ctx context.Context, in *GetCountRequest, opts ...grpc.CallOption) (*Count, error) {
	out := new(Count)
	err := c.cc.Invoke(ctx, CountApi_GetCount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *countApiClient) ResetCount(ctx context.Context, in *ResetCountRequest, opts ...grpc.CallOption) (*Count, error) {
	out := new(Count)
	err := c.cc.Invoke(ctx, CountApi_ResetCount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *countApiClient) UpdateCount(ctx context.Context, in *UpdateCountRequest, opts ...grpc.CallOption) (*Count, error) {
	out := new(Count)
	err := c.cc.Invoke(ctx, CountApi_UpdateCount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *countApiClient) PullCounts(ctx context.Context, in *PullCountsRequest, opts ...grpc.CallOption) (CountApi_PullCountsClient, error) {
	stream, err := c.cc.NewStream(ctx, &CountApi_ServiceDesc.Streams[0], CountApi_PullCounts_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *countInfoClient) DescribeCount(ctx context.Context, in *DescribeCountRequest, opts ...grpc.CallOption) (*CountSupport, error) {
	...
	err := c.cc.Invoke(ctx, CountInfo_DescribeCount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
