...
func (x *PullInputResponse_Change) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
var file_traits_input_select_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x52, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x2d,
...
var file_traits_input_select_proto_depIdxs = []int32{
	...
	10, // 7: smartcore.traits.PullInputResponse.Change.create_time:type_name -> google.protobuf.Timestamp
