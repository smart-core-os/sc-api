...
func (c *lockUnlockApiClient) GetLockUnlock(ctx context.Context, in *GetLockUnlockRequest, opts ...grpc.CallOption) (*LockUnlock, error) {
	out := new(LockUnlock)
	err := c.cc.Invoke(ctx, LockUnlockApi_GetLockUnlock_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lockUnlockApiClient) UpdateLockUnlock(ctx context.Context, in *UpdateLockUnlockRequest, opts ...grpc.CallOption) (*LockUnlock, error) {
	out := new(LockUnlock)
	err := c.cc.Invoke(ctx, LockUnlockApi_UpdateLockUnlock_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lockUnlockApiClient) PullLockUnlock(ctx context.Context, in *PullLockUnlockRequest, opts ...grpc.CallOption) (LockUnlockApi_PullLockUnlockClient, error) {
	stream, err := c.cc.NewStream(ctx, &LockUnlockApi_ServiceDesc.Streams[0], LockUnlockApi_PullLockUnlock_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
