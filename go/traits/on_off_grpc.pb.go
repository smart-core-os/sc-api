...
func (c *onOffApiClient) GetOnOff(ctx context.Context, in *GetOnOffRequest, opts ...grpc.CallOption) (*OnOff, error) {
	out := new(OnOff)
	err := c.cc.Invoke(ctx, OnOffApi_GetOnOff_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *onOffApiClient) UpdateOnOff(ctx context.Context, in *UpdateOnOffRequest, opts ...grpc.CallOption) (*OnOff, error) {
	out := new(OnOff)
	err := c.cc.Invoke(ctx, OnOffApi_UpdateOnOff_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *onOffApiClient) PullOnOff(ctx context.Context, in *PullOnOffRequest, opts ...grpc.CallOption) (OnOffApi_PullOnOffClient, error) {
	stream, err := c.cc.NewStream(ctx, &OnOffApi_ServiceDesc.Streams[0], OnOffApi_PullOnOff_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *onOffInfoClient) DescribeOnOff(ctx context.Context, in *DescribeOnOffRequest, opts ...grpc.CallOption) (*OnOffSupport, error) {
	...
	err := c.cc.Invoke(ctx, OnOffInfo_DescribeOnOff_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
