...
const (
	...
	AirTemperatureMode_AIR_TEMPERATURE_MODE_UNKNOWN AirTemperatureMode = 0
	// Write-only. If the device is OFF restore it to it's previous state
	AirTemperatureMode_AIR_TEMPERATURE_MODE_ON AirTemperatureMode = 1
	// Attr, read, write. The device supports, is, or should be disabled
	AirTemperatureMode_AIR_TEMPERATURE_MODE_OFF AirTemperatureMode = 2
	// Attr, read, write. The device supports, is, or should be heating
	AirTemperatureMode_AIR_TEMPERATURE_MODE_HEAT AirTemperatureMode = 3
	// Attr, read, write. The device supports, is, or should be cooling
	AirTemperatureMode_AIR_TEMPERATURE_MODE_COOL AirTemperatureMode = 4
	...
	AirTemperatureMode_AIR_TEMPERATURE_MODE_HEAT_COOL AirTemperatureMode = 5
	// Attr. The device supports automatic control of set points and/or schedules based on some other means (AI for
	// example)
	AirTemperatureMode_AIR_TEMPERATURE_MODE_AUTO AirTemperatureMode = 6
	// Attr, read, write. The device supports, is, or should be able to use only the fan without heating/cooling elements.
	AirTemperatureMode_AIR_TEMPERATURE_MODE_FAN_ONLY AirTemperatureMode = 7
	// Attr, read, write. The device supports, is, or should be in an energy saving "eco" mode
	AirTemperatureMode_AIR_TEMPERATURE_MODE_ECO AirTemperatureMode = 8
	// Attr, read, write. The device supports, is, or should be in an air purifying mode
	AirTemperatureMode_AIR_TEMPERATURE_MODE_PURIFIER AirTemperatureMode = 9
	// Attr, read, write. The device supports, is, or should be in an air drying mode
	AirTemperatureMode_AIR_TEMPERATURE_MODE_DRY AirTemperatureMode = 10
	// Attr, read, write. The device supports, is, or should be in locked mode (i.e. not user-editable)
	AirTemperatureMode_AIR_TEMPERATURE_MODE_LOCKED AirTemperatureMode = 11
)

// Enum value maps for AirTemperatureMode.
var (
	AirTemperatureMode_name = map[int32]string{
		0:  "AIR_TEMPERATURE_MODE_UNKNOWN",
		1:  "AIR_TEMPERATURE_MODE_ON",
		2:  "AIR_TEMPERATURE_MODE_OFF",
		3:  "AIR_TEMPERATURE_MODE_HEAT",
		4:  "AIR_TEMPERATURE_MODE_COOL",
		5:  "AIR_TEMPERATURE_MODE_HEAT_COOL",
		6:  "AIR_TEMPERATURE_MODE_AUTO",
		7:  "AIR_TEMPERATURE_MODE_FAN_ONLY",
		8:  "AIR_TEMPERATURE_MODE_ECO",
		9:  "AIR_TEMPERATURE_MODE_PURIFIER",
		10: "AIR_TEMPERATURE_MODE_DRY",
		11: "AIR_TEMPERATURE_MODE_LOCKED",
	}
...
func (x *AirTemperature) GetMode() AirTemperatureMode {
	...
	return AirTemperatureMode_AIR_TEMPERATURE_MODE_UNKNOWN
}
...
var file_traits_air_temperature_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x45,
	0x0a, 0x0b, 0x6e, 0x61, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x75, 0x6e, 0x69, 0x74, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x24, 0x2e, 0x73, 0x6d, 0x61, 0x72, 0x74, 0x63, 0x6f, 0x72, 0x65, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x54, 0x65, 0x6d, 0x70, 0x65, 0x72,
	0x61, 0x74, 0x75, 0x72, 0x65, 0x55, 0x6e, 0x69, 0x74, 0x52, 0x0a, 0x6e, 0x61, 0x74, 0x69, 0x76,
	0x65, 0x55, 0x6e, 0x69, 0x74, 0x12, 0x4d, 0x0a, 0x0f, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74,
	0x65, 0x64, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x24,
	...
	,
	...
	0x72, 0x65, 0x12, 0x67, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x69, 0x72, 0x54,
	0x65, 0x6d, 0x70, 0x65, 0x72, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x2d, 0x2e, 0x73, 0x6d, 0x61,
	...
	0x72, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x73, 0x6d, 0x61, 0x72,
	0x74, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x74, 0x72, 0x61, 0x69, 0x74, 0x73, 0x2e, 0x41, 0x69, 0x72,
	0x54, 0x65, 0x6d, 0x70, 0x65, 0x72, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x71, 0x0a, 0x12, 0x50,
	0x75, 0x6c, 0x6c, 0x41, 0x69, 0x72, 0x54, 0x65, 0x6d, 0x70, 0x65, 0x72, 0x61, 0x74, 0x75, 0x72,
	...
	,
