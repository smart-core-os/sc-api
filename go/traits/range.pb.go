...
func (x *PullRangeValueResponse_Change) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
var file_traits_range_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x3e, 0x0a, 0x0b, 0x72, 0x61, 0x6e,
...
var file_traits_range_proto_depIdxs = []int32{
	...
	8, // 3: smartcore.traits.PullRangeValueResponse.Change.create_time:type_name -> google.protobuf.Timestamp
