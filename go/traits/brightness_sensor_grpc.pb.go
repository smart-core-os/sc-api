...
func (c *brightnessSensorApiClient) GetAmbientBrightness(ctx context.Context, in *GetAmbientBrightnessRequest, opts ...grpc.CallOption) (*AmbientBrightness, error) {
	...
	err := c.cc.Invoke(ctx, BrightnessSensorApi_GetAmbientBrightness_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *brightnessSensorApiClient) PullAmbientBrightness(ctx context.Context, in *PullAmbientBrightnessRequest, opts ...grpc.CallOption) (BrightnessSensorApi_PullAmbientBrightnessClient, error) {
	stream, err := c.cc.NewStream(ctx, &BrightnessSensorApi_ServiceDesc.Streams[0], BrightnessSensorApi_PullAmbientBrightness_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *brightnessSensorInfoClient) DescribeAmbientBrightness(ctx context.Context, in *DescribeAmbientBrightnessRequest, opts ...grpc.CallOption) (*AmbientBrightnessSupport, error) {
	...
	err := c.cc.Invoke(ctx, BrightnessSensorInfo_DescribeAmbientBrightness_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
