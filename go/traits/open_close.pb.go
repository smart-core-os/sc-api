...
func (x *PullOpenCloseStatesResponse_Change) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
var file_traits_open_close_proto_rawDesc = []byte{
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x37, 0x0a, 0x05, 0x73, 0x74,
...
var file_traits_open_close_proto_depIdxs = []int32{
	...
	12, // 7: smartcore.traits.PullOpenCloseStatesResponse.Change.create_time:type_name -> google.protobuf.Timestamp
